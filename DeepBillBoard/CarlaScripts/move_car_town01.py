...
'''
This program moves the car created by OpenPilot to another road (here it is for town 01) since the spawn points have changed when we added our billboard
